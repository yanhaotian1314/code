...
public class Monster {
    ...
    public void monster() {
        System.out.println("怪兽等级为：" + this.getLevel() + "经验值为：" + this.getExperienceValue() + "物理值" + this.getPhysicalValues() + "防御值为：" + this.getDefenseValue() + "魔法值为:" + this.getMana() + "血条为：" + this.getArticleBlood() + "怒气值为：" + this.getAngerValue());
    }
}
